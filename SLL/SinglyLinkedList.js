...
function SinglyLinkedList(props) {
...
// Function to update linked list data in Firestore
    ...
    <div className="container">
      <div className="row">
        ...
        <div className="col-md-6 operation-container">
          ...
          <RenderSLL linkedList={linkedList} />
          {selectedLinkedList && (
        <RenderSLL linkedList={selectedLinkedList} />
      )}       
        </div>
